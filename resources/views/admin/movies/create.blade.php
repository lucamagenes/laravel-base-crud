        ...
        <form action="{{ route('movies.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="cover" id="cover" class="form-control @error('cover') is-invalid @enderror"
                    placeholder="https://" aria-describedby="coverHelper" maxlength="255" value="{{ old('cover') }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1900" max="2099" step="1" name="year" id="year" class="form-control"
                    placeholder="2000" aria-describedby="yearHelper" value="{{ old('year') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="thumb" id="thumb" class="form-control @error('thumb') is-invalid @enderror"
                    placeholder="https://" aria-describedby="thumbHelper" maxlength="255" value="{{ old('thumb') }}">
